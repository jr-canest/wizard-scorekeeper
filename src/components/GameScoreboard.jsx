export default function GameScoreboard({ players, rounds, totalScores, onClose }) {
      ...
      <div className="p-4 max-w-lg mx-auto">
        ...
        <div className="bg-gray-800 rounded-xl overflow-hidden mb-4">
          <div className="px-3 py-2 border-b border-gray-700">
            <span className="text-gray-400 text-sm font-medium">Standings</span>
          </div>
            ...
            return (
              <div
                ...
                className={`flex items-center justify-between px-3 py-2.5 border-b border-gray-700/50 last:border-0 ${
                  i === 0 && total > 0 ? 'bg-amber-900/20' : ''
                }`}
              >
                <div className="flex items-center gap-2">
                  <span className={`text-sm font-bold w-8 ${i === 0 && total > 0 ? 'text-amber-400' : 'text-gray-500'}`}>
                    {positions[i]}
                  </span>
